...
// Componente reutilizável para um bloco de pergunta
const QuestionBlock = ({ name, question, options }) => {
  ...
  return (
    <div className="form-section">
      ...
      <div className="grupo-de-perguntas">
        {/* Mensagem que aparece se nenhuma dimensão foi selecionada */}
        {selectedDimensions.length === 0 && (
          <p className="mensagem-aviso">Por favor, volte à etapa anterior e selecione pelo menos uma dimensão para avaliar.</p>
        )}

        {/* Bloco de Perguntas para Pessoas & Cultura */}
        ...
        {/* Bloco de Perguntas para Estrutura & Operações */}
        ...
        {/* Bloco de Perguntas para Mercado & Clientes */}
        ...
        {/* Bloco de Perguntas para Direção & Futuro */}
