    ...
    <div className="form-section">
      ...
      <div className="grupo-de-perguntas">
        <div className="input-group">
          ...
          {errors.faixaInvestimento && <p className="error">{errors.faixaInvestimento.message}</p>}
        </div>
        ...
        <div className="input-group">
          ...
          {errors.aberturaInovacao && <p className="error">{errors.aberturaInovacao.message}</p>}
        </div>
      </div>
    </div>
  );
