    ...
    <div className="form-section">
      ...
      <div className="grupo-de-perguntas">
        ...
        <div className="input-group">
          ...
          {errors.desafiosPrioritarios?.message && (
            <p className="error">{errors.desafiosPrioritarios.message as string}</p>
          )}
        </div>
        ...
        <div className="input-group">
          ...
          {errors.objetivosPrincipais?.message && (
            <p className="error">{errors.objetivosPrincipais.message as string}</p>
          )}
        </div>
        ...
        <div className="input-group">
          ...
          {errors.dimensoesAvaliar?.message && (
            <p className="error">{errors.dimensoesAvaliar.message as string}</p>
          )}
        </div>
